...
import { UserContext } from '../../App';
    ...
    <h1>{ newUser ? 'Create an account' : 'Login'}</h1>
        ...
        {newUser ? 'Sign In' : 'Create an account'} </button></p>
            ...
            <button className=" googleSignInBtn"  onClick={googleSignInEventHandler} > Continue With Google </button>
            <button className="faceBookSignInBtn" onClick={facebookSignInEventHandler}> Continue With Facebook </button> 
    </div>
        );
    };
